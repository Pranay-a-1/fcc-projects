...
var ServerStub = function () {
    ...
    },
    {
      ...
      data: {
        personal: {
          ...
          phoneNumber: 0399998888,
          emailAddress: "mark.dude@email.com",
        },
        accounts: [
          {
            summary: {
    ...
    accounts.forEach(function (account) {
      if (account.summary.number == transferModel.toAccount.summary.number) {
        account.summary.balance =
          account.summary.balance + transferModel.amount;
  ...
  var updatePersonalInformation = function (personalInformation, clientToken) {
    ...
    member.personal.phoneNumber =
      personalInformation.contactDetails.phoneNumber;
    member.personal.emailAddress =
      personalInformation.contactDetails.emailAddress;
